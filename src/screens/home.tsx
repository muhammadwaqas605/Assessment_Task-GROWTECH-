        ...
        <View style={styles.background}>
          <View style={styles.header}>
            <View style={styles.headerView}>
              <Text style={styles.h2}>GROWTECH</Text>
              <Text style={styles.h1}>Application Verification</Text>
            </View>
            <View style={styles.headerRightView}>
              <Icon name="bell" size={24} color={colors.lightgrey} />
              <Icon name="menu" size={24} color={colors.lightgrey} />
            </View>
          </View>
            ...
            <View style={styles.cardView}>
              ...
              <View style={{ marginLeft: wp(2) }}>
                ...
                <View style={{ flexDirection: "row", alignItems: "center" }}>
                  <AntDesign name="idcard" size={24} color={colors.green} />
                  <Text
                    style={{
                      fontSize: hp(2),
                      color: colors.green,
